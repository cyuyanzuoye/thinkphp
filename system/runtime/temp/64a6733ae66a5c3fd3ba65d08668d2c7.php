<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\phpStudy\WWW\thinkphp\public/../system/admin/index\view\index\index.html";i:1473494417;}*/ ?>
    ...
    BUI.use('common/main',function(){
        var config = [{
            ...
            menu:[{
                text:'首页内容',
                items:[
                    {id:'code',text:'首页代码',href:'index/index/hellow.html',closeable : false},
